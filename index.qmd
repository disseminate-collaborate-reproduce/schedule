...
-   **Install and setup git** [`r fa(name = "video")`](https://drive.google.com/file/d/1_I9fOIpBs1Oc1EkFKd-BMe_X2_NpP3um/view?usp=share_link) [`r fa(name = "desktop")`](https://github.com/disseminate-collaborate-reproduce/slides/main/00-install-git.html)
